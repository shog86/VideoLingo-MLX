...
export const getStaticProps = ({ params }) => {
    return Promise.all([
        fetch(`https://api.github.com/repos/shog86/VideoLingo-MLX`).then(res => res.json()),
        fetch(`https://api.github.com/repos/shog86/VideoLingo-MLX/contributors?per_page=16`).then(res => res.json())
...
export default function Component() {
    const landingData = {
        hero: {
            title: "VideoLingo-MLX: Connecting Every Frame Across the World",
        ...
        comments: {
            title: "They're All Using VideoLingo-MLX",
            items: [
                {
        ...
        faq: {
            ...
            items: [
                ...
                },
                {
                    ...
                    answer: "VideoLingo-MLX is an open-source fork of VideoLingo that has already gained a strong community. More features are coming soon~"
                },
            ]
        }
    }
